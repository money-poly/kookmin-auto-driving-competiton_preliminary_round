...
warp_src  = np.array([
    [200-warpx_margin, 300-warpy_margin],  
    [0-warpx_margin,  400+warpy_margin],
    [440+warpx_margin, 300-warpy_margin],
    [640+warpx_margin, 400+warpy_margin]
], dtype=np.float32)
...
def draw_lane(image, warp_img, Minv, left_fit, right_fit):
    ...
    ploty = np.linspace(0, yMax - 1, yMax) # 1 ~ 239 240개로 쪼갬
